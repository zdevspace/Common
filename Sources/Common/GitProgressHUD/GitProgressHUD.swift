...
public protocol GitProgressHUDDelegate {
    // Called after the hud was fully hidden from the screen, default not do anything
    func hudWasHidden(_ hud: GitProgressHUD)
}

extension GitProgressHUDDelegate {
    func hudWasHidden(_ hud: GitProgressHUD) {
    }
}
...
public class GitProgressHUD: UIView {
    ...
    public var delegate: GitProgressHUDDelegate?
    ...
    public class func show(addedToView view: UIView, animated: Bool) -> GitProgressHUD {
        let hud = GitProgressHUD(withView: view)
    ...
    public class func hudForView(_ view: UIView) -> GitProgressHUD? {
        let subviews = view.subviews.reversed()
        for subview in subviews {
            if (subview is GitProgressHUD) {
                return subview as? GitProgressHUD
            }
        }
