...
/// Class to build `GitAlertView`
public class GitAlertView: UIView {
...
extension GitAlertView {
    ...
    func addButton(_ button: GitAlertAction, actionCallback: GitAlertActionCallbackProtocol?) {
        let buttonView = GitAlertButtonView(type: .system)
...
/**
 * Extensios that implements GitAlert constraints to:
 *  - Title Label
 *  - Custom View
 *  - Buttons Stack View
 */
...
extension GitAlertView {
    ...
    @objc override public dynamic var cornerRadius: CGFloat {
