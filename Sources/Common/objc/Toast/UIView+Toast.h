...
extern const NSString * GitToastPositionTop;
extern const NSString * GitToastPositionCenter;
extern const NSString * GitToastPositionBottom;
...
/**
 ...
 The `gitToast:` methods create a new view and then display it as toast.
...
/**
 ...
 @param position The toast's center point. Can be one of the predefined GitToastPosition
...
/**
 ...
 The look and feel is configured via the style. Unlike the `gitToast:` methods,
...
/**
 ...
 calls to `gitToastActivity:` will be ignored until hideToastActivity is called.
 
 @warning `gitToastActivity:` works independently of the showToast: methods. Toast activity
 views can be presented and dismissed while toast views are being displayed. `gitToastActivity:`
...
/**
 `GitToastStyle` instances define the look and feel for toast views created via the
 `gitToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `GitToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface GitToastStyle : NSObject
...
/**
 The size of the toast activity view when `gitToastActivity:` is called.
...
/**
 Creates a new instance of `GitToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `GitToastStyle`.
 */
...
/**
 `GitToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface GitToastManager : NSObject

/**
 Sets the shared style on the singleton. The shared style is used whenever
 a `gitToast:` method (or `toastViewForMessage:title:image:style:`) is called
 with with a nil style. By default, this is set to `GitToastStyle`'s default
 style.
...
/**
 Sets the default duration. Used for the `gitToast:` and
...
/**
 Sets the default position. Used for the `gitToast:` and
 `showToast:` methods that don't require an explicit position.
 Default is `GitToastPositionBottom`.
 
 @param position The default center point. Can be one of the predefined
 GitToastPosition constants or a `CGPoint` wrapped in an `NSValue` object.
 */
+ (void)setDefaultPosition:(id)position;

/**
 Returns the default toast position. Default is `GitToastPositionBottom`.
