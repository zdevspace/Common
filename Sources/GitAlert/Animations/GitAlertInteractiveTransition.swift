//
//  GitAlertInteractiveTransition.swift
//  GGITCommon iOS
//
...
/// Class to build `GitAlertInteractiveTransition`
class GitAlertInteractiveTransition: UIPercentDrivenInteractiveTransition {
...
internal extension GitAlertInteractiveTransition {
